...
if (isset($_POST['save'])) {
    ...
    if ($status == "tersedia") {
        $tglKembali = NULL; // otomatis dikosongkan
    }
    ...
    /* === MODE EDIT === */
        ...
        if ($newName != "") {
            ...
            if ($old && $old['img'] != "default.jpg" && file_exists("../img/".$old['img'])) {
                unlink("../img/".$old['img']);
            }
...
if (isset($_GET['hapus'])) {
    ...
    if ($d && $d['img'] != "default.jpg" && file_exists("../img/" . $d['img'])) {
        unlink("../img/" . $d['img']);
    }
...
<head>
<meta charset="UTF-8">
<title>Admin SIPUS</title>

<link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;600;700&display=swap" rel="stylesheet">

<style>
/* —— TEMA EMAS (TIDAK DIUBAH) —— */
:root{
    --emas:#f5d388;
    --emas2:#f0c46c;
...
// tampilkan jika edit mode & status dipinjam
