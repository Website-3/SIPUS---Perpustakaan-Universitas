...
<head>
<meta charset="UTF-8">
<title>Koleksi Buku – SIPUS</title>
...
/* ===== BOOK CARD (SOLID / TIDAK TRANSPARAN) ===== */
.book-grid{
    display:grid;
...
.main-content {
    ...
    /* 150px itu perkiraan tinggi navbar + footer */
}
...
<video class="bg-video" autoplay muted loop>
    <source src="img/cari.mp4" type="video/mp4">
</video>
...
<ul>
    ...
    <li><a class="active">Koleksi Buku</a></li>
...
search.addEventListener("input", function(){
    ...
    if (q.trim() === "") {
        render([]); // kosong kalau belum cari apa-apa
        return;
    }
